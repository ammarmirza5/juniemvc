Analyze the file /prompts/add_dtos/requirements-draft.md and inspect t  he project. Improve and rewrite the draft requirements to a new file called /prompts/add-dtos/requirements.md.

Analyze the '/prompts/add-dtos/requirements.md' and create a detailed plan for the imporviements for this project.
